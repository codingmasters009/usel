...
import i1 from "../images/ipod/n1.jpg";
import i2 from "../images/ipod/n2.jpg";
import i3 from "../images/ipod/n3.jpg";
import i4 from "../images/ipod/n4.jpg";
import i5 from "../images/ipod/n5.jpg";
import i6 from "../images/ipod/n6.jpg";
import i7 from "../images/ipod/n7.jpg";
const IpodNanoSection = () => {
  let { cat } = useParams();
  return (
    <div>
          ...
          <center>
            <div className="ProductVarientGrid">
              <div className="productView">
                ...
                <center>
                  <Link to="/IpodOfferSection/7th Generation/7" className=" ">
              ...
              <div className="productView">
                ...
                <center>
                  <Link to="/IpodOfferSection/6th Generation/8" className=" ">
              ...
              <div className="productView">
                ...
                <center>
                  <Link to="/IpodOfferSection/5th Generation/9" className=" ">
                    <div className="textColor">5th Generation</div>
                  </Link>
                </center>
              </div>
              <div className="productView">
                <Link to="/IpodOfferSection/4th Generation/10" className=" ">
                  <center>
              ...
              <div className="productView">
                <Link to="/IpodOfferSection/3th Generation/11" className=" ">
                  <center>
              ...
              <div className="productView">
                <Link to="/IpodOfferSection/2th Generation/12" className=" ">
                  <center>
                    <img src={i6} alt="Girl in a jacket" />

                    <div className="textColor"> 2nd Generation</div>
                  </center>
                </Link>
              </div>{" "}
              <div className="productView">
                <Link to="/IpodOfferSection/2th Generation/13" className=" ">
                  <center>
                    <img src={i7} alt="Girl in a jacket" />

                    <div className="textColor">1st Generation</div>
                  </center>
                </Link>
              </div>
            </div>
...
export default IpodNanoSection;
