...
import a1 from "../images/gameconsole/nintendo/1.png";
import a2 from "../images/gameconsole/nintendo/2.png";
import a3 from "../images/gameconsole/nintendo/3.png";
import a4 from "../images/gameconsole/nintendo/4.png";
import a5 from "../images/gameconsole/nintendo/5.png";
import a6 from "../images/gameconsole/nintendo/6.png";
import a7 from "../images/gameconsole/nintendo/7.png";
import a8 from "../images/gameconsole/nintendo/8.png";
import a9 from "../images/gameconsole/nintendo/9.png";
import a10 from "../images/gameconsole/nintendo/10.png";
import a11 from "../images/gameconsole/nintendo/11.png";
import a12 from "../images/gameconsole/nintendo/12.png";
import a13 from "../images/gameconsole/nintendo/13.png";
import a14 from "../images/gameconsole/nintendo/14.png";
import a15 from "../images/gameconsole/nintendo/15.png";
import a16 from "../images/gameconsole/nintendo/16.png";
import a17 from "../images/gameconsole/nintendo/17.png";
import a18 from "../images/gameconsole/nintendo/18.png";
import a19 from "../images/gameconsole/nintendo/19.png";
import a20 from "../images/gameconsole/nintendo/20.png";

import varientInfo from "../images/varientInfo.png";
import "./general.css";
const GameNintendoVarient = () => {
  let { cat } = useParams();
  return (
    <div>
            ...
            <div className="ProductVarientGrid">
              ...
              <div className="productView">
                <Link to="/Varientipad/ipad" className=" ">
                  <center>
                    <div className="productViewSectionImg">
                      <img src={a10} alt="Girl in a jacket" />
                    </div>
                    <center>
                      <div className="textColor productViewSectionText">
                        Nintendo NEW 3DS XL
              ...
              <div className="productView">
                <Link to="/Varientipad/ipad" className=" ">
                  <center>
                    <div className="productViewSectionImg">
                      <img src={a11} alt="Girl in a jacket" />
                    </div>
                    <center>
                      <div className="textColor productViewSectionText">
                        Nintendo Switch
              ...
              <div className="productView">
                <Link to="/Varientipad/ipad" className=" ">
                  <center>
                    <div className="productViewSectionImg">
                      <img src={a12} alt="Girl in a jacket" />
                    </div>
                    <center>
                      <div className="textColor productViewSectionText">
                        Nintendo Wii
...
export default GameNintendoVarient;
