          ...
          <center>
            <div className="ProductVarientGrid">
              <div className="productView">
                <Link to="/ApplePancilVarient/Apple Pencil" className=" ">
                  <center>
              ...
              <div className="productView">
                <Link to="/AppleKeyboardVarient/Keyboard" className=" ">
                  <center>
                    <div className="productViewSectionImg">
              ...
              <div className="productView">
                <Link to="/AppleDisplayVarient/Apple Display" className=" ">
                  <center>
                    <div className="productViewSectionImg">
