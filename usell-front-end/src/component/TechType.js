...
import a2 from "../images/tech/at.jpg";
import a3 from "../images/tech/c1.jpg";
import a4 from "../images/tech/cam.jpg";
import a5 from "../images/tech/cameralens.jpg";
import a6 from "../images/tech/computerpart.jpg";
import a7 from "../images/tech/computerperipherals.jpg";
import a8 from "../images/tech/d5.jpg";
import a9 from "../images/tech/g4.jpg";
import a10 from "../images/tech/h5.jpg";
import a11 from "../images/tech/mp3player.jpg";
import a12 from "../images/tech/mediaplayer.jpg";
import a13 from "../images/tech/mb2.jpg";
import a14 from "../images/tech/w2.jpg";
import a15 from "../images/tech/sh2.jpg";
import a16 from "../images/tech/s1.jpg";
import a17 from "../images/tech/v1.jpg";
import a18 from "../images/tech/vg1.jpg";
import a19 from "../images/tech/we2.jpg";
        ...
        <div className="ProductVarientdiv">
          <center>
            <div className="ProductVarientGrid">
              ...
              <div className="productView">
                <Link to="/AppleTvType/Apple Tv" className=" ">
                  <center>
                    <div className="productViewSectionImg">
              ...
              <div className="productView">
                <Link to="/CalculatorVarient/Calculator" className=" ">
                  <center>
                    <div className="productViewSectionImg">
              ...
              <div className="productView">
                <Link to="/CameraLenseVareint/Canon Camera Lens" className=" ">
                  <center>
                    <div className="productViewSectionImg">
              ...
              <div className="productView">
                <Link to="/ComputerPartsType/Computer Parts" className=" ">
                  <center>
                    <div className="productViewSectionImg">
              ...
              <div className="productView">
                <Link to="/ComputerPeraphil/Computer Peripherals" className=" ">
                  <center>
                    <div className="productViewSectionImg">
              ...
              <div className="productView">
                <Link to="/DroneCompany/ipad" className=" ">
                  <center>
                    <div className="productViewSectionImg">
              ...
              <div className="productView">
                <Link to="/GPSCompany/ GPS" className=" ">
                  <center>
                    <div className="productViewSectionImg">
              ...
              <div className="productView">
                <Link to="/HEadPhoneCompany/Headphones" className=" ">
                  <center>
                    <div className="productViewSectionImg">
