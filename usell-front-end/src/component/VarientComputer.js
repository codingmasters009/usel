...
import a1 from "../images/computer/L1.jpg";
import a2 from "../images/computer/D1.jpg";
// import a3 from "../images/gameconsole/microsoft/3.png";
// import a4 from "../images/gameconsole/microsoft/4.png";
import varientInfo from "../images/varientInfo.png";
import "./general.css";
const VarientComputer = () => {
  let { cat } = useParams();
          ...
          <center>
            <div className="ProductVarientGrid">
              <div className="productView">
                <Link to="/CumputerLaptop/computer2" className=" ">
                  <center>
              ...
              <div className="productView">
                <Link to="/ComputerDesktop/computer2" className=" ">
                  <center>
                    <div className="productViewSectionImg">
...
export default VarientComputer;
