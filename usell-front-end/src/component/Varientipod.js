...
import i1 from "../images/ipod01.png";
import i2 from "../images/ipod02.png";
import i3 from "../images/ipod03.png";
import i4 from "../images/ipod04.png";
const Varientipod = () => {
  let { cat } = useParams();
  return (
    <div>
          ...
          <center>
            <div className="ProductVarientGrid">
              <div className="productView">
                <Link to="/IpodClasicSection/ipad" className=" ">
                  <center>
                    <img src={i1} alt="Girl in a jacket" />

                    <div className="textColor">Classic</div>
                  </center>
                </Link>
              </div>
              <div className="productView">
                <Link to="/IpodNanoSection/ipad" className=" ">
                  <center>
                    <img src={i2} alt="Girl in a jacket" />

                    <div className="textColor">Nano</div>
                  </center>
                </Link>
              </div>
              <div className="productView">
                ...
                <center>
                  <Link to="/Varientipad/ipad" className=" ">
                    <div className="textColor">Shuffle</div>
                  </Link>
                </center>
              </div>
              <div className="productView">
                ...
                <center>
                  <Link to="/Varientipad/ipad" className=" ">
                    <div className="textColor">Touch</div>
                  </Link>
                </center>
              </div>
            </div>
