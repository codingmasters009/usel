...
import a1 from "../images/gameconsole/listbrands/1.png";
import a2 from "../images/gameconsole/listbrands/2.png";
import a3 from "../images/gameconsole/listbrands/3.png";
const Varientgameconsole = () => {
  let { cat } = useParams();
  return (
    <div>
          ...
          <center>
            <div className="ProductVarientGrid">
              <div className="productView">
                <Link to="/GameSamsungVarient/GameConsole" className=" ">
                  <center>
              ...
              <div className="productView">
                <Link to="/GameNintendoVarient/GameConsole" className=" ">
                  <center>
              ...
              <div className="productView">
                <Link to="/GameSonyVarient/GameConsole" className=" ">
                  <center>
...
export default Varientgameconsole;
