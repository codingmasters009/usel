...
import w1 from "../images/watch01.png";
import w2 from "../images/watch02.png";
import w3 from "../images/watch03.png";
import w4 from "../images/watch04.png";
import w5 from "../images/watch05.png";
import w6 from "../images/watch06.png";
const Varientwatch = () => {
  let { cat } = useParams();
  return (
    <div>
          ...
          <center>
            <div className="ProductVarientGrid">
              <div className="productView">
                <center>
                  <img src={w1} alt="Girl in a jacket" />
                </center>
                <center>
                  <Link to="/Varientipad/ipad" className=" ">
                    <div className="textColor">Original</div>
                  </Link>
                </center>
              </div>
              <div className="productView">
                <center>
                  <img src={w2} alt="Girl in a jacket" />
                </center>
                <center>
                  <Link to="/Varientipad/ipad" className=" ">
                    <div className="textColor">Series 1</div>
                  </Link>
                </center>
              </div>
              <div className="productView">
                <center>
                  <img src={w3} alt="Girl in a jacket" />
                </center>
                <center>
                  <Link to="/Varientipad/ipad" className=" ">
                    <div className="textColor">Series 2</div>
                  </Link>
                </center>
              </div>
              <div className="productView">
                <center>
                  <img src={w4} alt="Girl in a jacket" />
                </center>
                <center>
                  <Link to="/Varientipad/ipad" className=" ">
                    <div className="textColor">Series 3</div>
                  </Link>
                </center>
              </div>
              <div className="productView">
                <center>
                  <img src={w5} alt="Girl in a jacket" />
                </center>
                <center>
                  <Link to="/Varientipad/ipad" className=" ">
                    <div className="textColor">Series 4</div>
                  </Link>
                </center>
              </div>
              <div className="productView">
                <center>
                  <img src={w6} alt="Girl in a jacket" />
                </center>
                <center>
                  <Link to="/Varientipad/ipad" className=" ">
                    <div className="textColor">Series 5</div>
                  </Link>
                </center>
              </div>
            </div>
