...
import acomputer01 from "../images/acomputer01.png";
import acomputer02 from "../images/acomputer02.png";
import acomputer03 from "../images/acomputer03.png";
import acomputer04 from "../images/acomputer04.png";

const Varientacomputer = () => {
  let { cat } = useParams();
  return (
    <div>
          ...
          <center>
            <div className="ProductVarientGrid">
              <div className="productView">
                <center>
                  <img src={acomputer01} alt="Girl in a jacket" />
                </center>
                <center>
                  <Link to="/Varientipad/ipad" className=" ">
                    <div className="textColor">MacBook</div>
                  </Link>
                </center>
              </div>
              <div className="productView">
                <center>
                  <img src={acomputer02} alt="Girl in a jacket" />
                </center>
                <center>
                  <Link to="/Varientipad/ipad" className=" ">
                    <div className="textColor">iMac</div>
                  </Link>
                </center>
              </div>{" "}
              <div className="productView">
                <center>
                  <img src={acomputer03} alt="Girl in a jacket" />
                </center>
                <center>
                  <Link to="/Varientipad/ipad" className=" ">
                    <div className="textColor">Mac Mini</div>
                  </Link>
                </center>
              </div>{" "}
              <div className="productView">
                <center>
                  <img src={acomputer04} alt="Girl in a jacket" />
                </center>
                <center>
                  <Link to="/Varientipad/ipad" className=" ">
                    <div className="textColor">Mac Pro</div>
                  </Link>
                </center>
              </div>
            </div>
...
export default Varientacomputer;
