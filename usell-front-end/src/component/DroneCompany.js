...
import a1 from "../images/tech/dc2.png";
import a2 from "../images/tech/dc1.png";
            ...
            <div className="ProductVarientGrid">
              <div style={{ display: "flex" }}>
                <div className="productView">
                  <Link to="/DroneShowProduct/1" className=" ">
                    <center>
                ...
                <div className="productView">
                  <Link to="/DroneShowProduct/2" className=" ">
                    <center>
                      <div className="productViewSectionImg">
