...
import macbook01 from "../images/macbook01.png";
import macbook02 from "../images/mackbook02.png";
import macbook03 from "../images/mackbook03.png";

const Varientmackbook = () => {
  let { cat } = useParams();
  return (
    <div>
          ...
          <center>
            <div className="ProductVarientGrid">
              <div className="productView">
                <center>
                  <img src={macbook01} alt="Girl in a jacket" />
                </center>
                <center>
                  <Link to="/Varientipad/ipad" className=" ">
                    <div className="textColor">MackBook</div>
                  </Link>
                </center>
              </div>{" "}
              <div className="productView">
                <center>
                  <img src={macbook02} alt="Girl in a jacket" />
                </center>
                <center>
                  <Link to="/Varientipad/ipad" className=" ">
                    <div className="textColor">MackBook Air</div>
                  </Link>
                </center>
              </div>
              <div className="productView">
                <center>
                  <img src={macbook03} alt="Girl in a jacket" />
                </center>
                <center>
                  <Link to="/Varientipad/ipad" className=" ">
                    <div className="textColor">MackBook Pro</div>
                  </Link>
                </center>
              </div>
            </div>
...
export default Varientmackbook;
